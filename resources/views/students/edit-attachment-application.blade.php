        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <a href="{{ asset('storage/studentcvs/'.$application->uploaded_cv) }}" class="btn btn-sm btn-block btn-info" download="">{{ $application->uploaded_cv }}</a>
                    <hr>
                    <p><span class="text-danger">Attachment Letter</span></p>
                    <a href="{{ asset('storage/attachment_letter/'.$application->attachmentletters) }}" class="btn btn-sm btn-block btn-primary" download="">{{ $application->attachment_letter }}</a>
                    <hr>
                </div>
            </div>
            <br>
            ...
            <div class="box jumbotron">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form action="{{ url('student/update-attachment') }}" method="POST"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <textarea name="description"
                                                    ...
                                                    cols="30" rows="10"
                                                    placeholder="Justify to us why you really need this attachment opportunity">{{ $application->student_description }}</textarea>
                                            </div>
                                            @error('description')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <input type="hidden" name="attachmenttask" value="{{ $application->id }}">
                                </div>

                                <div class="text-xs-right">
                                    <button type="submit" class="btn btn-rounded btn-warning">Update Attachment
                                        Application</button>
                                </div>
                            </form>

...
<!-- Mirrored from creativelayers.net/themes/superio/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Oct 2021 06:36:00 GMT -->
    ...
    <div class="page-wrapper dashboard ">
        ...
        <header class="main-header">
                            ...
                            <li class="mm-add-listing">
                                ...
                                <span>
                                    <span class="contact-info">
                                        <span class="phone-num"><span>Call us</span><a href="tel:1234567890">+25473 456
                                                7890</a></span>
                                        <span class="address">329 Tom Boya Street, NAirobi <br>3051, Kenya.</span>
                                        <a href="mailto:support@superio.com"
                                            class="email">support@studentattachee.com</a>
                                    </span>
            ...
            <div class="mobile-header">
                <div class="logo"><a href="index.html"><img src="{{asset('frontend/images/logo.svg')}}" alt=""
                            title=""></a></div>

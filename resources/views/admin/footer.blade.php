            ...
            <div class="media-list media-list-hover mt-20">
                ...
                <div class="media py-10 px-0">
                    <a class="avatar avatar-lg status-danger" href="#">
                        <img src="{{ asset('main/images/avatar/2.jpg')}}" alt="...">
                    </a>
                    <div class="media-body">
                        <p class="font-size-16">
                ...
                <div class="media py-10 px-0">
                    <a class="avatar avatar-lg status-warning" href="#">
                        <img src="{{ asset('main/images/avatar/3.jpg')}}" alt="...">
                    </a>
                    <div class="media-body">
                        <p class="font-size-16">
                ...
                <div class="media py-10 px-0">
                    <a class="avatar avatar-lg status-primary" href="#">
                        <img src="{{ asset('main/images/avatar/4.jpg')}}" alt="...">
                    </a>
                    <div class="media-body">
                        <p class="font-size-16">
                            <a class="hover-primary" href="#"><strong>Evan</strong></a>
...
<div class="sticky-toolbar">
    ...
    <a href="https://themeforest.net/user/multipurposethemes/portfolio" data-toggle="tooltip" data-placement="left"
        title="Portfolio" class="waves-effect waves-light btn btn-danger btn-flat mb-5 btn-sm" target="_blank">
            ...
            <div class="chat-logs">
                <div class="chat-msg user">
                    <div class="d-flex align-items-center">
                        <span class="msg-avatar">
                            <img src="{{ asset('main/images/avatar/2.jpg')}}" class="avatar avatar-lg">
                        </span>
                        <div class="mx-10">
                ...
                <div class="chat-msg self">
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <span class="msg-avatar">
                            <img src="{{ asset('main/images/avatar/3.jpg')}}" class="avatar avatar-lg">
                        </span>
                    </div>
                    <div class="cm-msg-text">
